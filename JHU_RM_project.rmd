...
lm1
```
So if all the other variates were randomly assigned to the 2 transmission groups we coulc conclude that automatic cars had a higher mpg than manual cars. This is physically plausible.
